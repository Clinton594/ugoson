...
<!-- Mirrored from netgon.net/artstyles/v-card/dark/single-post.html by HTTrack Website Copier/3.x [XR&CO'2008], Sat, 16 Nov 2019 06:07:14 GMT -->
<head>
    <meta charset="utf-8" />
...
<body class="bg-triangles">
					            ...
					            <div class="comment-box">
								    <div class="comment-box__inner">
                                        ...
                                        <div class="comment-box__body">
                                            ...
                                            <p>I agree, a very interesting article. Thank you very much! <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-nerd.svg" alt="nerd"/></p>
								...
								<div class="dropdown dropup">
								    ...
								    <div class="dropdown-menu dropdown-menu-center" aria-labelledby="dropdownEmoji">
									    <div class="emoji-wrap">
                                            <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-laughing.svg" title=":laughing:" alt="laughing"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-happy-2.svg" title=":happy 2:" alt="happy 2"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-crazy.svg" title=":crazy:" alt="crazy"/>
											<img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-bad.svg" title=":bad:" alt="bad"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-angry.svg" title=":angry:" alt="angry"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-happy.svg" title="happy" alt="happy"/>
                                            <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-thinking.svg" title=":thinking:" alt="thinking"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-sad.svg" title=":sad:" alt="sad"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-pressure.svg" title=":pressure:" alt="pressure"/>
											<img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-in-love.svg" title=":in love:" alt="in love"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-nerd.svg" title=":laughing:" alt="nerd"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-happy-3.svg" title=":happy 3:" alt="happy 3"/>
                                            <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-shocked.svg" title=":shocked:" alt="shocked"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-wink.svg" title=":wink:" alt="wink"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-sweating.svg" title=":sweating:" alt="sweating"/>
											<img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-shocked-2.svg" title=":shocked 2:" alt="shocked 2"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-shocked-3.svg" title=":shocked 3:" alt="shocked 3"/>
										    <img class="emoji" src="http://netgon.net/artstyles/v-card/assets/icons/emoji/emoji-sad-2.svg" title=":sad 2:" alt="sad 2"/>
										</div>
                                    </div>
                                </div>
							</form>
    ...
    <ul class="slideNav">
	    <li class="slideNav__item"><h4 class="title title--5">More pages</h4></li>
        <li class="slideNav__item"><a href="background-2.html">1. Background turquoise</a></li>
        <li class="slideNav__item"><a href="background-3.html">2. Background green</a></li>
		<li class="slideNav__item"><a href="menu_alternative/about.html">3. Alternative menu</a></li>
    </ul>
...
<!-- Mirrored from netgon.net/artstyles/v-card/dark/single-post.html by HTTrack Website Copier/3.x [XR&CO'2008], Sat, 16 Nov 2019 06:07:15 GMT -->
</html>
