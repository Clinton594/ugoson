    ...
    <div className="sidebar__info box-inner">
      <ul className="contacts-block text-left" style={{marginBottom:0}}>
        <li className="contacts-block__item" data-toggle="tooltip" data-placement="top" title="linkedIn">
          <a href="https://www.linkedin.com/in/clinton-onuigbo-a5112810b/"><i className="fab fa-linkedin mr-2"></i>LinkedIn Profile</a>
        </li>
        <li className="contacts-block__item" data-toggle="tooltip" data-placement="top" title="WhatsApp">
          <a href={`whatsapp://send?phone=${profile.phones.airtel}`}><i className="fab fa-whatsapp mr-2"></i>WhatsApp</a>
        </li>
        <li className="contacts-block__item" data-toggle="tooltip" data-placement="top" title="Phone">
          <a href={`tel://${profile.phones.airtel}`}><i className="fa fa-phone mr-2"></i>{`${profile.phones.airtel}`}</a>
        </li>
        <li className="contacts-block__item" data-toggle="tooltip" data-placement="top" title="Facebook">
          <a href="https://web.facebook.com/Clinton594"><i className="fab fa-facebook mr-2"></i> Facebook Profile</a>
        </li>
      </ul>
      <a className="btn" href={`mailto:${profile.email}`}><i className="font-icon icon-envelope"></i> <small>Get in Touch [Email]</small>
      </a>
    </div>
  </div>
</aside>
